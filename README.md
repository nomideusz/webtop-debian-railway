# Deploy and Host a Linux Desktop (Debian KDE Plasma) on Railway
...
- Idle footprint is about 460 MB, so it squeezes onto the 512 MB Trial plan; give it 1 GB or more for comfortable use, 2 GB if you run a browser or an IDE inside.
